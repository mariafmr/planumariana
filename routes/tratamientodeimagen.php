...
//existe o no una imagen
    $threat = App\Threat::find(1);
    $image = $threat->image;
        if ($image) {
...
$threat = App\Threat::find(1);
return  $threat->images->url;

//03 muchas imagenes
   $threat = App\Threat::find(1);
   $threat->images()->saveMany([
    new App\Image(['url'=> 'imagenes/a.jpeg']),
    new App\Image(['url'=> 'imagenes/a.jpeg']),
    new App\Image(['url'=> 'imagenes/a.jpeg']),
    ]); 
...
//04 crear una imagen para un usuario utilizando el metodo create
 ...
 $threat = App\Threat::find(1);
 $threat->images->url='imagenes/a.jpeg';
 $threat->push();
 return  $threat->images;

//06 actualizar imagenes muchos a muchos
$threat = App\Threat::find(1);
$threat->images[0]->url='imagenes/a2.jpeg';
$threat->push();
return  $threat->images;
...
$threat = App\Threat::find(2);
return $threat->images()->where('url','imagenes/a.png')->get();

//10 ordenar registros que provienen de la relacion.
$threat = App\Threat::find(2);
return $threat->images()->where('url','imagenes/a.png')->orderBy('id','Desc')->get();
