...
<head>
  ...
  <title>PLAN EMERGENCIAS UNIMAR @yield('titulo')</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../adminlte/index3.html" class="nav-link">INICIO</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="../principal/images/avatar1.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="/planemergencias" class="brand-link">
      <img src="../../adminlte/dist/img/AdminLTELogo.png"
           alt="AdminLTE Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">PLAN DE EMERGENCIA</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="../principal/images/avatar1.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('amenazas.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lista-Amenazas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('tipoamenazas.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('brigadas.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lista-Organización-Brigada</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../layout/boxed.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lista-Brigadistas</p>
                </a>
              </li>
            </ul>
          </li>
